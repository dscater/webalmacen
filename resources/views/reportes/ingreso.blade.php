...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">INGRESO A ALMACÉN</h4>
    </div>

    <table>
        <tbody>
            <tr>
                <td class="bold" width="14%">Proveedor:</td>
                <td>{{ $ingreso->proveedor->razon_social }}</td>
                <td class="bold" width="14%">Nro. Factura:</td>
                <td>{{ $ingreso->nro_factura }}</td>
            </tr>
            <tr>
                <td class="bold">Tipo de Ingreso:</td>
                <td>{{ $ingreso->tipo_ingreso->nombre }}</td>
    ...
    <table border="1">
        ...
        <tbody>
            @php
                ...
                $total = 0;
            @endphp
            @foreach ($ingreso->ingreso_detalles as $item)
                <tr>
                    <td>{{ $cont++ }}</td>
